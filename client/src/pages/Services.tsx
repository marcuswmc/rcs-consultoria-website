  ...
  const services = [
    {
      ...
      description: "Sua empresa aberta em tempo recorde com velocidade máxima.",
      details: ["CNPJ em dias", "Alvarás Rápidos", "Contratos Ágeis", "Assessoria Completa"]
    },
    {
      icon: <Calculator className="h-8 w-8" />,
      title: "Gestão Tributária Fast",
      description: "Planejamento focado em redução imediata de custos fiscais.",
      details: ["Redução de Impostos", "Recuperação Ágil", "Planejamento Estratégico", "Compliance Digital"]
    },
    {
      icon: <Briefcase className="h-8 w-8" />,
      title: "Consultoria Premium",
      description: "Diagnóstico direto ao ponto para melhorar a saúde financeira hoje.",
    ...
    <div className="min-h-screen flex flex-col bg-background font-sans w-full overflow-x-hidden">
      ...
      <div className="bg-primary text-white py-16 md:py-24 relative overflow-hidden w-full">
        ...
        <div className="w-full px-4 md:px-12 xl:px-24 relative z-10 text-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tighter">Soluções <span className="text-accent">Fast</span></h1>
        ...
        <div className="w-full px-4 md:px-12 xl:px-24">
          <div className="max-w-[1920px] mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                <Card className="h-full hover:shadow-xl transition-all duration-300 border-none bg-white p-4 rounded-3xl">
          ...
          <div className="mt-24 text-center bg-primary rounded-[2rem] p-10 md:p-16 text-white relative overflow-hidden">
            <div className="absolute inset-0 bg-accent/10 opacity-20 rotate-12 translate-x-1/2" />
            <div className="relative z-10 max-w-3xl mx-auto space-y-6">
              <h2 className="text-3xl md:text-5xl font-bold">Precisa de uma solução imediata?</h2>
              ...
              <Link href="/contato">
                <Button size="lg" className="bg-white text-primary hover:bg-white/90 font-bold px-10 h-14 text-lg rounded-xl shadow-xl">
